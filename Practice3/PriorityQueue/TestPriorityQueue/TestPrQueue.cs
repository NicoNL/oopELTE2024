...
// GivenWhenThen (GWT) , TestDrivenDev (TDD)
...
namespace TestPriorityQueue
{
    ...
    public class TestPrQueue
    {
        ...
        public void TestRemMax()
        {
            ...
            Assert.IsTrue(e == e1);
            //e.priorityValue = 42;
            //Assert.IsTrue(e.priorityValue == e1.priorityValue);
            //Item special = new Item(1,"a");
            //Assert.IsTrue(e.priorityValue == special.priorityValue);
            //Assert.IsTrue(e == special);  // will fail
            e = Q.RemMax();
